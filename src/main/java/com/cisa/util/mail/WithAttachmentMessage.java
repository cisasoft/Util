...
public class WithAttachmentMessage {
    ...
    public MimeMessage createMessage(Session session) throws Exception {  
        ...
        MimeBodyPart attachment01 = createAttachment("c:\\test\\w环境监测需求.docx");  
        MimeBodyPart attachment02 = createAttachment("c:\\test\\w.pdf");  
        MimeBodyPart content = createContent(body, "c:\\test\\snap.jpg");  
        ...
        msg.setContent(allPart,"text/html");  
        msg.saveChanges();  
        return msg;  
    }  
    ...
    public static void main(String[] args) throws Exception {  
        ...
        message.writeTo(new FileOutputStream("c:\\test\\withAttachmentMail.eml"));  
    }  
